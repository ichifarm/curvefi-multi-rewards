...
import { Address, IERC20, Math, Owned, Pausable, ReentrancyGuard, SafeERC20, SafeMath } from "./MultiRewards.sol";

contract MultiRewardsMinimal is ReentrancyGuard, Pausable {
